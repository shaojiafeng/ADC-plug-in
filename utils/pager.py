...
class Pagination(object):
    ...
    def page_html(self):
        ...
        if self.current_page != 1:
            ...
            up_page = '<li><a href="%s?%s">上一页</a></li>' % (self.base_url,self.params.urlencode())
        ...
        for i in range(pager_start, pager_end + 1):
            ...
            if i == self.current_page:
                ...
                temp = '<li class="active"><a href="%s?%s">%s</li>' % (self.base_url,self.params.urlencode(), i,)
            else:
